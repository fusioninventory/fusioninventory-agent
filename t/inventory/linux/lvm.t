...
foreach my $test (keys %vgs) {
    my @groups = FusionInventory::Agent::Task::Inventory::OS::Linux::LVM::_getVolumeGroups(file => "resources/lvm/linux/vgs/$test");
    is_deeply(\@groups, $vgs{$test}, "vgs parsing: $test");
}
