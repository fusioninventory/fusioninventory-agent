...
my %fromWalk = (
    'iso.0.8802.1.1.1.1.1.2.1.3.20' => '1.0.8802.1.1.1.1.1.2.1.3.20'
);

my %toWalk = (
    '1.0.8802.1.1.1.1.1.2.1.3.20' => 'iso.0.8802.1.1.1.1.1.2.1.3.20'
);
...
my %walks = (
    sample1 => {
        get => {
            ...
            '1.3.6.1.6.3.18.1.1.1.4.49' => '0000000B0000001871C1E000'
        },
        walk => {
            '1.0.8802.1.1.2.1.3.7.1.2' => {
                '1.0.8802.1.1.2.1.3.7.1.2.2' => '7',
                '1.0.8802.1.1.2.1.3.7.1.2.1' => '7',
                '1.0.8802.1.1.2.1.3.7.1.2.4' => '7',
                '1.0.8802.1.1.2.1.3.7.1.2.3' => '7',
                '1.0.8802.1.1.2.1.3.7.1.2.6' => '7',
                '1.0.8802.1.1.2.1.3.7.1.2.5' => '7'
            }
        }
    },
    sample2 => {
...
foreach my $walk (keys %walks) {
    ...
    foreach my $oid (keys %{$walks{$walk}->{get}}) {
        is($snmp->get($oid), $walks{$walk}->{get}{$oid});
    }

    foreach my $oid (keys %{$walks{$walk}->{walk}}) {
        is_deeply($snmp->walk($oid), $walks{$walk}->{walk}{$oid});
    }
