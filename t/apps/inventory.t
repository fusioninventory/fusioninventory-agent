...
($out, $err, $rc) = run_executable(
    'fusioninventory-inventory',
    "--no-category printer --no-category software --additional-content $file"
);
...
($out, $err, $rc) = run_executable(
    'fusioninventory-inventory',
    "--no-category printer --no-category software"
);
...
($out, $err, $rc) = run_executable(
    'fusioninventory-inventory',
    "--no-category printer --no-category software --no-category environment"
);
