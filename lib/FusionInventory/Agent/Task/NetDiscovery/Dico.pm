...
<SNMPDISCOVERY>
   ...
   <DEVICE SYSDESCR="HP Color LaserJet 2600n" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0093" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="HP LaserJet M1522nf MFP" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0111" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="hp color LaserJet 2500" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0081" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="Brother NC-6400h, Firmware Ver.1.01  (05.08.31),MID 84UZ92" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0194" SERIAL=".1.3.6.1.4.1.2435.2.3.9.4.2.1.5.5.1.0" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="Dell Color Laser 3110cn; Net 8.43, Controller 200804091041, Engine 05.09.00" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0128" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="3Com IntelliJack NJ225" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0274" SERIAL=".1.3.6.1.4.1.43.29.4.18.2.1.7.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   ...
   <DEVICE SYSDESCR="Cisco IOS Software, C870 Software (C870-ADVIPSERVICESK9-M), Version 12.4(4)T7, RELEASE SOFTWARE (fc1)&#13;&#10;Technical Support: http://www.cisco.com/techsupport&#13;&#10;Copyright (c) 1986-2006 by Cisco Systems, Inc.&#13;&#10;Compiled Wed 29-Nov-06 00:43 by kellythw" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0260" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1"/>
   ...
   <DEVICE SYSDESCR="RICOH Aficio MP C2800 1.23 / RICOH Network Printer C model / RICOH Network Scanner C model / RICOH Network Facsimile C model" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0161" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   <DEVICE SYSDESCR="ProCurve J9279A Switch 2510G-24, revision Y.11.08, ROM N.10.02 (/sw/code/build/cod(cod11))" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0043" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Cisco Internetwork Operating System Software   &#13;&#10;IOS (tm) CIGESM Software (CIGESM-I6Q4L2-M), Version 12.1(22)EA9, RELEASE SOFTWARE (fc1)  &#13;&#10;Copyright (c) 1986-2006 by cisco Systems, Inc.  &#13;&#10;Compiled Fri 01-Dec-06 17:59 by weiliu" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0256" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   ...
   <DEVICE SYSDESCR="Ethernet Routing Switch 4550T-PWR     HW:03       FW:5.1.0.7   SW:v5.1.0.000 BN:00 (c) Nortel Networks" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0007" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   ...
   <DEVICE SYSDESCR="HP J4865A ProCurve Switch 4108GL, revision G.07.107, ROM G.05.02 (/sw/code/build/gamo(m03))" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0043" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Cisco Internetwork Operating System Software &#13;&#10;IOS (tm) 3600 Software (C3620-I-M), Version 12.0(9), RELEASE SOFTWARE (fc1)&#13;&#10;Copyright (c) 1986-2000 by cisco Systems, Inc.&#13;&#10;Compiled Wed 26-Jan-00 14:03 by bettyl" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0261" SERIAL=".1.3.6.1.4.1.9.3.6.3.0" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Cisco Internetwork Operating System Software &#13;&#10;IOS (tm) 3700 Software (C3725-IS-M), Version 12.3(5a), RELEASE SOFTWARE (fc1)&#13;&#10;Copyright (c) 1986-2003 by cisco Systems, Inc.&#13;&#10;Compiled Mon 24-Nov-03 20:36 by kellythw" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0258" SERIAL=".1.3.6.1.4.1.9.3.6.3.0" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="HP J4813A ProCurve Switch 2524, revision F.05.72, ROM F.02.01  (/sw/code/build/info(s02))" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0043" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Brother NC-8100h, Firmware Ver.1.60  (02.11.13),MID 8X5-549" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0192" SERIAL=".1.3.6.1.4.1.2435.2.3.9.4.2.1.5.5.1.0" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   <DEVICE SYSDESCR="DesignJet 800PS (C7780C)" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0093" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   <DEVICE SYSDESCR="Deskjet 1280" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0093" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   <DEVICE SYSDESCR="Xerox WorkCentre 7235;ESS PS1.220.3,IOT 1.3.0,FIN B3.1.3,IIT 7.6.0,ADF 11.6.3" MANUFACTURER="0" TYPE="3" MODELSNMP="Printer0193" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   ...
   <DEVICE SYSDESCR="Cisco Systems, Inc. WS-C4506&#13;&#10;Cisco Catalyst Operating System Software, Version 8.4(9)GLX&#13;&#10;Copyright (c) 1995-2005 by Cisco Systems, Inc.&#13;&#10;&#13;&#10;" MANUFACTURER="0" TYPE="2" MODELSNMP="Networking0269" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Brother NC-6200h, Firmware Ver.H  ,MID 8C5-A45,FID 2" MANUFACTURER="-1" TYPE="3" MODELSNMP="Printer0103" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
   <DEVICE SYSDESCR="PROCURVE J9028B - PB.03.00" MANUFACTURER="-1" TYPE="2" MODELSNMP="Networking0275" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Cisco IOS Software, C1700 Software (C1700-ADVIPSERVICESK9-M), Version 12.4(23), RELEASE SOFTWARE (fc1)&#13;&#10;Technical Support: http://www.cisco.com/techsupport&#13;&#10;Copyright (c) 1986-2008 by Cisco Systems, Inc.&#13;&#10;Compiled Sat 08-Nov-08 18:56 by prod_rel_team" MANUFACTURER="-1" TYPE="2" MODELSNMP="Networking0276" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Cisco IOS Software, C3560 Software (C3560-ADVIPSERVICESK9-M), Version 12.2(46)SE, RELEASE SOFTWARE (fc2)&#13;&#10;Copyright (c) 1986-2008 by Cisco Systems, Inc.&#13;&#10;Compiled Thu 21-Aug-08 15:26 by nachen" MANUFACTURER="-1" TYPE="2" MODELSNMP="Networking0088" SERIAL=".1.3.6.1.2.1.47.1.1.1.1.11.1001" MAC=".1.3.6.1.2.1.17.1.1.0"/>
   <DEVICE SYSDESCR="Xerox WorkCentre 7345;ESS1.231.5,IOT 3.0.4,FIN B3.1.3,IIT 20.4.1,ADF 20.0.0,SJFI3.0.8,SSMI1.7.0" MANUFACTURER="-1" TYPE="3" MODELSNMP="Printer0193" SERIAL=".1.3.6.1.2.1.43.5.1.1.17.1" MACDYN=".1.3.6.1.2.1.2.2.1.6"/>
</SNMPDISCOVERY>
';
