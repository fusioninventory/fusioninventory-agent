package FusionInventory::Agent::Message::Outbound;
...
FusionInventory::Agent::Message::Outbound - Message from agent to server

=head1 DESCRIPTION

This is an XML messages sent by the agent to the server.
