package Ocsinventory::Agent::Task::Inventory::OS::Linux::Storages::ServeRaid;
...
#         FRU part number          : 32P0729
				...
				if (/.*FRU part number.*:\s(.*)/) {
					my $model = $1;
					my $manufacturer = Ocsinventory::Agent::Task::Inventory::OS::Linux::Storages::getManufacturer($serial);
