package Ocsinventory::Agent::Task::Inventory::Virtualization::Vmsystem;

# Initial Ocsinventory::Agent::Task::Inventory::Virtualization::Vmsystem version: Nicolas EISEN
#
