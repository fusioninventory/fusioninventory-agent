package Ocsinventory::Agent::Task::Inventory;
...
#      print STDERR "$module loaded in $calling_namespace!\n";
  ...
  eval "use Ocsinventory::Agent::Task::Inventory::ModuleToLoad;";
  if (!$@) {
    $logger->debug("use Ocsinventory::Agent::Task::Inventory::ModuleToLoad to get the modules ".
      "to load. This should not append unless you use the standalone agent built with ".
      "PAR::Packer (pp)");
    push @installed_mods, @Ocsinventory::Agent::Task::Inventory::ModuleToLoad::list;
  }
