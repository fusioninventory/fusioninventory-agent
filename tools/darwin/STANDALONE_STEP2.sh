...
tar -zvcf OCSNG.pkg.tar.gz --exclude=CVS 10_3_9-startup/ org.ocsng.agent.plist OCSNG.pkg installer-darwin.sh uninstall-darwin.sh dscl-adduser.sh dscl-remove-user.sh ocsinventory-agent.cfg modules.conf cacert.pem
